...
@RestController
@RequestMapping("/v1/configuration/{profile}/http")
public final class Http {

    @PostMapping(value = "save", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<String> applyConfiguration(@RequestBody HttpConfiguration httpConfiguration, @PathVariable String profile) throws IOException {
        ...
        ConfigurationStore.save(profile, httpConfiguration);
    ...
    public ResponseEntity<String> getConfiguration(@PathVariable String profile) {
        ...
        try {
            ...
            if (profile.equalsIgnoreCase("default")) {
                ...
                httpConfiguration = ConfigurationStore.load(profile, HttpConfiguration.class);
            }
            http = JsonParser.parseString(JacksonJson.get(httpConfiguration)).getAsJsonObject();
        } catch (Exception ex) {
