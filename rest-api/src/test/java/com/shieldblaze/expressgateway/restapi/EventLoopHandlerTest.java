...
class EventLoopHandlerTest {
    ...
    @Test
    @Order(1)
    void createConfig() throws IOException, InterruptedException {
    ...
    @Test
    @Order(3)
    void deleteConfig() throws IOException, InterruptedException {
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .DELETE()
                .uri(URI.create("http://127.0.0.1:9110/config/eventloop"))
                .build();
    ...
    @Test
    @Order(4)
    void testDeleteConfig() throws IOException, InterruptedException {
        HttpRequest httpRequest = HttpRequest.newBuilder()
                .GET()
                .uri(URI.create("http://127.0.0.1:9110/config/eventloop"))
                .build();
