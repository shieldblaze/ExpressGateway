...
class ClusterHandlerTest {
    ...
    private final L4LoadBalancerTest l4LoadBalancerTest = new L4LoadBalancerTest();
    private final L7LoadBalancerTest l7LoadBalancerTest = new L7LoadBalancerTest();
    ...
    @Test
    @Order(1)
    void addL4ClusterTest() throws IOException, InterruptedException {
        ...
        assertNull(property.l4LoadBalancer().cluster("DEFAULT"));
        ...
        property = LoadBalancerRegistry.get(L4LoadBalancerTest.id);
        assertNotNull(property.l4LoadBalancer().cluster("DEFAULT"));
    }

    @Test
    @Order(2)
    void deleteL4ClusterTest() throws IOException {
        LoadBalancerProperty property = LoadBalancerRegistry.get(L4LoadBalancerTest.id);
        assertNotNull(property.l4LoadBalancer().cluster("DEFAULT"));
    ...
    @Test
    @Order(3)
    void addL7ClusterTest() throws IOException, InterruptedException {
        ...
        assertNull(property.l4LoadBalancer().cluster("www.shieldblaze.com"));
    ...
    @Test
    @Order(4)
    void remapL7ClusterTest() throws IOException {
        LoadBalancerProperty property = LoadBalancerRegistry.get(L7LoadBalancerTest.id);
        assertNotNull(property.l4LoadBalancer().cluster("www.shieldblaze.com"));
        assertNull(property.l4LoadBalancer().cluster("shieldblaze.com"));
    ...
    @Test
    @Order(5)
    void deleteL7ClusterTest() throws IOException {
        Request request = new Request.Builder()
                .url("http://127.0.0.1:9110/v1/cluster/delete?id=" + L4LoadBalancerTest.id + "&hostname=null")
                .delete()
                .build();
