...
/**
 * End-to-end control plane integration test against a real Consul 1.18 instance.
 */
@Testcontainers
class ConsulIntegrationTest extends AbstractControlPlaneIntegrationTest {
    ...
    private static ConsulKVStore kvStore;
    ...
    protected KVStore createKVStore() {
        ...
        Consul consul = Consul.builder()
                ...
                .build();
        kvStore = new ConsulKVStore(consul);
        return kvStore;
    }
