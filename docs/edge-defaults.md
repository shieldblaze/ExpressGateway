...
| H1 `keepalive_requests` count cap            | unbounded (pending L7-06)                           | n/a (per-listener)               | 100 (`keepalive_requests`)         | `crates/lb-l7/src/h1_proxy.rs` (no cap today)                            | Open: tracked under L7-06; deferred to Wave 2b.                       |
