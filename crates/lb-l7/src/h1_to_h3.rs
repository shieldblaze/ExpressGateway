...
/// Headers that must be removed when bridging from HTTP/1.1 to HTTP/3.
...
/// Bridge that converts HTTP/1.1 requests into HTTP/3 format.
pub struct H1ToH3Bridge;

impl Bridge for H1ToH3Bridge {
