...
//!
//! EBPF-2-01: the committed ELF is the load-bearing artefact, so a 64 KiB ceiling is enforced
//! here to stop unbounded size drift. `tests/elf_sections.rs` re-asserts the same invariant.
