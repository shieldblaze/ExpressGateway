...
import com.shieldblaze.expressgateway.backend.strategy.l7.http.WeightedRoundRobin;
...
class WeightedRoundRobinTest {
    ...
    void testWeightedRoundRobin() throws LoadBalanceException {
        ...
        HTTPBalance httpBalance = new WeightedRoundRobin(cluster);
    ...
    private Node fastBuild(String host, int weight) {
        return new Node(new InetSocketAddress(host, 1), weight, 1);
    }
}
