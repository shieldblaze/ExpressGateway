...
import com.shieldblaze.expressgateway.backend.strategy.l7.http.RoundRobin;
...
class StickySessionTest {
    ...
    void testStickySession() throws LoadBalanceException {
        Cluster cluster = ClusterPool.of(
                "localhost.domain",
                new Node(new InetSocketAddress("172.16.1.1", 9110)),
                new Node(new InetSocketAddress("172.16.1.2", 9110)),
                new Node(new InetSocketAddress("172.16.1.3", 9110)),
                new Node(new InetSocketAddress("172.16.1.4", 9110))
        );
