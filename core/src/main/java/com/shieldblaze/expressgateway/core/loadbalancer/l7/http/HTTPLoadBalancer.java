...
public abstract class HTTPLoadBalancer extends L7LoadBalancer {
     ...
     * @see L7LoadBalancer
     */
    HTTPLoadBalancer(InetSocketAddress bindAddress, HTTPL7Balance HTTPL7Balance, HTTPFrontListener httpFrontListener, Cluster cluster,
                     CommonConfiguration commonConfiguration, HTTPConfiguration httpConfiguration) {
        super(bindAddress, HTTPL7Balance, httpFrontListener, cluster, commonConfiguration);
