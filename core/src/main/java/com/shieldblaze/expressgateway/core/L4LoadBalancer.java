...
public abstract class L4LoadBalancer {
     ...
     */
    public L4LoadBalancer(InetSocketAddress bindAddress, LoadBalance<?, ?, ?, ?> loadBalance, L4FrontListener l4FrontListener, Cluster cluster,
        ...
        this.coreConfiguration = Objects.requireNonNull(coreConfiguration, "CommonConfiguration");
