...
public class HttpResponseDecoder extends HttpObjectDecoder {
    ...
    protected HttpMessage createMessage(String[] initialLine) {
        ...
        return new CustomHttpResponse(httpVersion, HttpResponseStatus.valueOf(Integer.parseInt(initialLine[1]), initialLine[2]), protocol, RANDOM.nextLong());
    }

    @Override
    protected HttpMessage createInvalidMessage() {
        return new CustomFullHttpResponse(HttpVersion.HTTP_1_0, UNKNOWN_STATUS, Unpooled.EMPTY_BUFFER, HttpFrame.Protocol.HTTP_1_0, RANDOM.nextLong());
    }
