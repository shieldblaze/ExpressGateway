...
public final class UpsertDataRequest extends KeyPairAdapter implements RequestMessage {

    private final ByteBuf id;

    @NonNull
    public UpsertDataRequest(ByteBuf id, List<KeyValuePair> keyValuePairList) {
