 ...
 */
package com.shieldblaze.expressgateway.intercommunication.messages.response;
...
public final class UpsertDataResponse extends KeyPairAdapter implements ResponseMessage {

    private final ByteBuf id;

    @NonNull
    public UpsertDataResponse(ByteBuf id, List<KeyValuePair> keyValuePairList) {
