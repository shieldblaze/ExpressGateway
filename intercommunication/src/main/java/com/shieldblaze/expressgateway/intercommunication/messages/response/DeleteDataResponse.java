...
public final class DeleteDataResponse extends KeyPairAdapter implements ResponseMessage {

    private final ByteBuf id;

    @NonNull
    public DeleteDataResponse(ByteBuf id, List<KeyValuePair> keyValuePairList) {
