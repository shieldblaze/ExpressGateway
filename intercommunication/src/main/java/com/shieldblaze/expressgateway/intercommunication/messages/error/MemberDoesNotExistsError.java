...
/**
 * See {@link Errors#MEMBER_DOES_NOT_EXISTS}
 */
public final class MemberDoesNotExistsError implements ResponseMessage {

    private final ByteBuf id;

    @NonNull
    public MemberDoesNotExistsError(ByteBuf id) {
        this.id = id;
    }
