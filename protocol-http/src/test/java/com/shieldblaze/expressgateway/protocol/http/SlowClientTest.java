...
class SlowClientTest {
    ...
    private static HttpConfiguration createShortTimeoutConfig() throws Exception {
        ...
        config.setMaxInitialLineLength(4096)
                ...
                .setMaxRequestBodySize(10L * 1024 * 1024)
                .setInitialWindowSize(1048576)
                .setH2ConnectionWindowSize(1048576)
                .setMaxConnectionBodySize(256L * 1024 * 1024)
                .setMaxHeaderListSize(8192)
                .setRequestHeaderTimeoutSeconds(HEADER_TIMEOUT_SECONDS)
                .setRequestBodyTimeoutSeconds(BODY_TIMEOUT_SECONDS)
